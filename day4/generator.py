...
if __name__ == '__main__':
    fake_chunks = [
        {'text': 'NexusChat is an enterprise RAG chatbot that answers questions from your documents. It supports PDF, DOCX, and TXT formats.', 'source': 'sample.pdf'},
        {'text': 'Users can ask natural language questions and receive cited answers. The system is built on Google Gemini and ChromaDB.', 'source': 'sample.pdf'},
        {'text': 'All AI-generated content must be reviewed by a human before publication. Employees must not share confidential data with external AI services.', 'source': 'sample.docx'},
    ]
